...
\normalsize
\\ ~~ \\
\textbf{In-class Date: Thursday 28 April}
...
\begin{verbatim}
[rzak1@linux1 cw9]$ submit cmsc104_1068 cw9 countchange.c makechange.c typescript
\end{verbatim}

\subsection*{Verify}
\paragraph{}Make sure you submitted the assignment correctly.
\begin{verbatim}
[rzak1@linux1 cw9]$ submitls cmsc104_1068 cw9
\end{verbatim}
