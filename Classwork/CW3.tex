...
\AtEndDocument{\vfill \footnotesize{Last modified: 08 September 2021}}
...
\normalsize
\\ ~~ \\
\textbf{In-class Date: Thursday  09 September}
...
\begin{enumerate}
    ...
    \begin{verbatim}
        [rzak1@linux1 cw3]$ submit cmsc104_10600 cw3 pseudocode.txt
    \end{verbatim}
    \item Check your submission
    \begin{verbatim}
        [rzak1@linux1 cw3]$ submitls cmsc104_10600 cw3
    \end{verbatim}
    \item Logout
    \begin{verbatim}
