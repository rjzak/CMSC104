...
\AtEndDocument{\vfill \footnotesize{Last modified: 26 September 2021}}
...
\normalsize
\\ ~~ \\
\textbf{In-class Date: Tuesday 28 September}
...
** Author:      <studentName>
** Date:        <date>
** Section:     CMSC104 Section 1 (10600)
...
\begin{verbatim}
    [rzak1@linux1 cw4]$ submit cmsc104_10600 cw4 height.c typescript
\end{verbatim}

\subsection*{Verify Submission}
\begin{verbatim}
    [rzak1@linux1 cw4]$ submitls cmsc104_10600 cw4
\end{verbatim}
