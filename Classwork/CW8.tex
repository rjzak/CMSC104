...
\AtEndDocument{\vfill \footnotesize{Last modified: 05 April 2022}}
...
\normalsize
\\ ~~ \\
\textbf{In-class Date: Thursday 21 April}
...
\subsection*{Notes}
\paragraph{}Use the classwork starting point provided on Blackboard and name your program \texttt{grades.c}.  It's also available here: \textattachfile[color=1 0 0]{CW8_grades.c}{grades.c}.
...
\begin{verbatim}
[rzak1@linux1 cw8]$ submit cmsc104_1068 cw8 grades.c typescript
\end{verbatim}

\subsection*{Verify}
\paragraph{}Make sure you submitted the assignment correctly.
\begin{verbatim}
[rzak1@linux1 cw8]$ submitls cmsc104_1068 cw8
\end{verbatim}
\end{document}