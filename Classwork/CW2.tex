...
\AtEndDocument{\vfill \footnotesize{Last modified: 31 January 2022}}
...
\normalsize
\\ ~~ \\
\textbf{In-class Date: Thursday 03 February}
...
\begin{enumerate}
    ...
    \begin{verbatim}
        [rzak1@linux1 cw2]$ submit cmsc104_1068 cw2 things2do.txt typescript
        [rzak1@linux1 cw2]$
    \end{verbatim}
    \item Double-check that the files were, in fact, submitted.
    \begin{verbatim}
        [rzak1@linux1 cw2]$ submitls cmsc104_1068 cw2
    \end{verbatim}
