...
\AtEndDocument{\vfill \footnotesize{Last modified: 01 September 2021}}
...
\normalsize
\\ ~~ \\
\textbf{In-class Date: Thursday  02 September}
...
\begin{enumerate}
    ...
    \begin{verbatim}
        [rzak1@linux1 cw2]$ submit cmsc104_10600 cw2 things2do.txt typescript
        [rzak1@linux1 cw2]$
    \end{verbatim}
    \item Double-check that the files were, in fact, submitted.
    \begin{verbatim}
        [rzak1@linux1 cw2]$ submitls cmsc104_10600 cw2
    \end{verbatim}
